...
interface TodoProps {
  todo: TodoField;
  completeTodo: (todo: TodoField) => void;
...
function Todo({
  ...
  return (
    <div className="my-2 px-5 border inline-flex items-center bg-white leading-none rounded-full p-2 shadow text-sm">
      ...
      <button
        type="button"
        className="uppercase p-3 flex items-center border border-red-600 text-red-600 max-w-max shadow-sm hover:shadow-lg rounded-full w-10 h-10 "
